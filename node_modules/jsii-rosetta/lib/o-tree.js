...
exports.ChildVisibilityOTree = exports.OTreeSink = exports.UnknownSyntax = exports.NO_SYNTAX = exports.OTree = void 0;
 ...
 */
class ChildVisibilityOTree extends OTree {
    write(sink) {
        if (!sink.tagOnce(this.options.renderOnce)) {
            return;
        }
...
exports.ChildVisibilityOTree = ChildVisibilityOTree;
