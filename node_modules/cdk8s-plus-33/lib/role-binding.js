...
class RoleBinding extends base_1.Resource {
    ...
    synthesizeSubjects() {
        return this._subjects.map(subject => subject.toSubjectConfiguration()).map((subject) => (0, utils_1.filterUndefined)({
...
RoleBinding[_a] = { fqn: "cdk8s-plus-33.RoleBinding", version: "2.5.7" };
/**
...
ClusterRoleBinding[_b] = { fqn: "cdk8s-plus-33.ClusterRoleBinding", version: "2.5.7" };
/**
 * Represents a user.
 */
...
User[_c] = { fqn: "cdk8s-plus-33.User", version: "2.5.7" };
/**
 * Represents a group.
 */
