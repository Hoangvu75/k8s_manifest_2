...
export declare class Code<T extends DiagnosticMessageFormatter = DiagnosticMessageFormatter> {
     ...
     */
    static lookupByPartialName(name: string): Code[];
...
export declare class JsiiDiagnostic implements ts.Diagnostic {
    ...
    static readonly JSII_1007_NEVER_TYPE: Code<() => string>;
    static readonly JSII_1008_ONLY_INTERFACE_INTERSECTION: Code<(type: string) => string>;
    ...
    static readonly JSII_1012_ONLY_CONST_ENUM_MEMBERS: Code<() => string>;
    ...
    static readonly JSII_4010_SUBMODULE_NAMESPACE_CONFLICT: Code<(language: string, namespace: string, modules: string[]) => string>;
